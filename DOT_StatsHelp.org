...
** DOING [1/7] Mean-estimation with a quantile over runs
*** Description
...
**** Fields and inner constructor
      ...
      #+BEGIN_SRC julia :tangle src/DOT_StatsHelp.jl
        ...
        function
        MeanProc_Full{𝐑}(;
                   true_μ ::ℝ, curr_emp_μ ::Vector{𝐑},
                         emp_var ::Vector{𝐑}, err ::Vector{ℝ}) where{𝐑}
            new(true_μ, curr_emp_μ, err, emp_var,
                0,0)
        end
      #+END_SRC
...
*** TODO User-facing constructor
*** TODO Starting a new step: ~start_step!()~
*** TODO Adding a data point: ~record_run!()~
