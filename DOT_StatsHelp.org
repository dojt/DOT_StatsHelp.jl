...
** Literate programming
   ...
   structure.  This makes orientation in the source code so much easier 😊.


* TODO Task Lists and Progress Reports [1/4]
** DONE Basics [1/1]
...
** IN-PRGR Mean-estimating process [7/8]
...
**** Implementation
      #+BEGIN_SRC julia :tangle src/DOT_StatsHelp.jl
                ...
                let 𝐫     = s.𝐫[],
                    ...
                    #
                    # emp_var[𝐫]   = (𝐬-1) ⋅ emp_var[𝐫]  / 𝐬    +   (𝐬-1) ⋅ norm²( curr_emp_μ - 𝐸 ) / 𝐬²
                    # curr_emp_μ  .= (𝐬-1) ⋅ curr_emp_μ / 𝐬   +   𝐸 / 𝐬

                    _ws         .= curr_emp_μ
                    axpby!(-1/𝐬, 𝐸,  1/𝐬, _ws)
                    emp_var[𝐫]   = (𝐬-1) ⋅ (   emp_var[𝐫]  / 𝐬    +   norm²( _ws )   )
...
**** Test with valency 0
      ...
      #+BEGIN_SRC julia :tangle test/runtests.jl
        function qnd_test_0(;runs=3,steps=4)
            ...
            mp = MeanProc( () ; steps,runs, #= 𝐑=Double64 =#)
...
** TODO Statistics of max-approximating processes
